...
RAG_MAX_DOCS           = _safe_int(os.getenv("RAG_MAX_DOCS"), 4)
...
RAG_WINDOW_LINES       = _safe_int(os.getenv("RAG_WINDOW_LINES"), 80)     # lines above/below each anchor (wider → complete spell/ability blocks)
...
_INIT_VALUES = {
    ...
    "RAG_WINDOW_LINES": RAG_WINDOW_LINES,
